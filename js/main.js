...
function renderActiveFilters() {
    ...
    const chipsHtml = items.map(item => `
        <button onclick="${item.onclick}" class="group animate-fade-in flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-lg text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:border-red-400 hover:text-red-500 transition-all shadow-sm">
            <span>${item.text}</span>
